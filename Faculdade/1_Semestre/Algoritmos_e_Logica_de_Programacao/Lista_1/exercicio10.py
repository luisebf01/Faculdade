...
#  de cigarros fumados por dia e quantos anos ele já fumou. Considere que um fumante perde 1 0 minutos 
# de vida a cada cigarro, calcule quantos dias de vida um fumante perderá. Exiba o total de dias.

qtdeCigarros = int(input("\nInsira quantos cigarros por dia você fuma: "))
...
print (f"\nVocê perdeu {resultadoFinal:.2f} dias de vida.\n")